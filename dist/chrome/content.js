(() => {
  ...
  var s = false;
  var c;
  var l = (e2 = globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__) => s ? true : (e2 && typeof e2.inject == `function` && (c = e2.inject.toString()), !!(c == null ? void 0 : c.includes(`(injected)`)));
  ...
  var p = (e2) => {
    ...
    try {
      ...
      (n2.renderers.size || n2._instrumentationIsActive || l()) && (e2 == null ? void 0 : e2());
    } catch {
    }
  };
  ...
  var g = () => {
    var _a, _b;
    return !!(typeof window < `u` && (((_a = window.document) == null ? void 0 : _a.createElement) || ((_b = window.navigator) == null ? void 0 : _b.product) === `ReactNative`));
  };
  var _ = () => {
    try {
      g() && h();
  ...
  var Te = () => {
    ...
    return !!(e2 == null ? void 0 : e2._instrumentationIsActive) || o(e2) || l(e2);
  };
  var Z = (e2) => {
    var _a, _b, _c, _d;
    let t2 = globalThis.__REACT_DEVTOOLS_GLOBAL_HOOK__;
    if (t2 == null ? void 0 : t2.renderers) for (let n2 of t2.renderers.values()) try {
      let t3 = (_a = n2.findFiberByHostInstance) == null ? void 0 : _a.call(n2, e2);
      if (t3) return t3;
    } catch {
    }
    if (typeof e2 == `object` && e2) {
      if (`_reactRootContainer` in e2) return (_d = (_c = (_b = e2._reactRootContainer) == null ? void 0 : _b._internalRoot) == null ? void 0 : _c.current) == null ? void 0 : _d.child;
  ...
  var m3 = (e2, t2) => {
    if ((t2 == null ? void 0 : t2.includeInElement) !== false) {
      let n2 = e2.split(`
`), r2 = [];
...
`), r2;
  ...
  var Se2 = (e2) => {
    var _a;
    return e2._debugStack instanceof Error && typeof ((_a = e2._debugStack) == null ? void 0 : _a.stack) == `string`;
  };
  var Ce2 = () => {
    let n2 = h();
  ...
  var N2 = (e2, t2) => {
    ...
    try {
      ...
      r3.DetermineComponentFrameRoot.displayName = `DetermineComponentFrameRoot`, ((_a = Object.getOwnPropertyDescriptor(r3.DetermineComponentFrameRoot, `name`)) == null ? void 0 : _a.configurable) && Object.defineProperty(r3.DetermineComponentFrameRoot, `name`, { value: `DetermineComponentFrameRoot` });
...
`, r2)), r2 !== -1) n2 = n2.slice(0, r2);
  ...
  var we2 = (e2) => {
    var _a;
    return !!(((_a = e2.fileName) == null ? void 0 : _a.startsWith(`rsc://`)) && e2.functionName);
  };
  ...
  var De = (e2, t2, n2) => {
    ...
    return n2.set(e2.functionName, i3 + 1), { ...e2, isServer: true, fileName: a3.fileName, lineNumber: a3.lineNumber, columnNumber: a3.columnNumber, source: (_a = e2.source) == null ? void 0 : _a.replace(`(at Server)`, `(${a3.fileName}:${a3.lineNumber}:${a3.columnNumber})`) };
  };
  var Oe2 = (e2) => {
    let t2 = [];
    return j(e2, (e3) => {
      ...
      t2.push({ componentName: r2, stackFrames: m3(I((_a = e3._debugStack) == null ? void 0 : _a.stack)) });
    }, true), t2;
  };
  var L2 = async (e2, t2 = true, n2) => {
    let r2 = Oe2(e2), i3 = m3(F2(e2)), a3 = Ee2(r2), o3 = /* @__PURE__ */ new Map();
    return xe2(i3.map((e3) => {
      var _a;
      return ((_a = e3.source) == null ? void 0 : _a.includes(`(at Server)`)) ?? false ? De(e3, a3, o3) : e3;
    }).filter((e3, t3, n3) => {
      if (t3 === 0) return true;
      let r3 = n3[t3 - 1];
  ...
  var it = (e2) => {
    ...
    let t2 = H2;
    if (t2 == null) return [];
    let n2 = (_a = t2.updateQueue) == null ? void 0 : _a.memoCache;
    if (n2 == null) return [];
  ...
  async function getSvelteMetaFromPage(element) {
    return new Promise((resolve) => {
      ...
      const handler = (event) => {
        var _a;
        if (((_a = event.data) == null ? void 0 : _a.callbackId) === callbackId) {
...
`;
  ...
  function removeOverlay() {
    ...
    (_a = document.querySelector(".opencode-selection-cancel")) == null ? void 0 : _a.remove();
  }
  ...
  async function captureDomContext(element) {
    ...
    return {
      ...
      attributes,
      textContent: ((_a = element.textContent) == null ? void 0 : _a.trim().slice(0, 200)) || "",
      computedStyles,
  ...
  function getComponentLabel(sourceInfo) {
    if (!(sourceInfo == null ? void 0 : sourceInfo.filePath)) return void 0;
  ...
  async function getCurrentTabId() {
    ...
    try {
      ...
      return (response == null ? void 0 : response.tabId) ?? null;
    } catch (err) {
